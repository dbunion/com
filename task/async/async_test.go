...
func TestTask(t *testing.T) {
	...
	cfg := task.Config{
		...
		BrokerConfig:    `{"MaxIdle":10, "MaxActive":100, "IdleTimeout": 300, "Wait": true, "ReadTimeout": 15, "WriteTimeout": 15, "ConnectTimeout": 15, "NormalTasksPollPeriod": 1000, "DelayedTasksPollPeriod": 20, "DelayedTasksKey": "REDIS_DELAYED_TASKS_KEY"}`,
